...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    icalToken: Attribute.String
    pushSubscriptions: Attribute.Relation<'plugin::users-permissions.user', 'oneToMany', 'api::push-subscription.push-subscription'>
    createdAt: Attribute.DateTime
    updatedAt: Attribute.DateTime
...
export interface ApiHistoryElementHistoryElement extends Schema.CollectionType {
  ...
  attributes: {
    action: Attribute.Enumeration<
      ['added', 'updated', 'watered', 'fertilized', 'repotted', 'pruned', 'image', 'sterilized', 'measured', 'note']
    >
    photo: Attribute.Media
    note: Attribute.Text
    plant: Attribute.Relation<'api::history-element.history-element', 'manyToOne', 'api::plant.plant'>
    status: Attribute.Enumeration<['active', 'archived']> & Attribute.DefaultTo<'active'>
    createdAt: Attribute.DateTime
    updatedAt: Attribute.DateTime
    createdBy: Attribute.Relation<'api::history-element.history-element', 'oneToOne', 'admin::user'> & Attribute.Private
    updatedBy: Attribute.Relation<'api::history-element.history-element', 'oneToOne', 'admin::user'> & Attribute.Private
  }
}
...
export interface ApiPlantPlant extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String & Attribute.Required
    photo: Attribute.Media
    botanicalName: Attribute.String
    tags: Attribute.Relation<'api::plant.plant', 'oneToMany', 'api::tag.tag'>
    history: Attribute.Relation<'api::plant.plant', 'oneToMany', 'api::history-element.history-element'>
    user: Attribute.Relation<'api::plant.plant', 'oneToOne', 'plugin::users-permissions.user'>
    reminder: Attribute.JSON
    status: Attribute.Enumeration<['active', 'archived']> & Attribute.DefaultTo<'active'>
    createdAt: Attribute.DateTime
    updatedAt: Attribute.DateTime
    createdBy: Attribute.Relation<'api::plant.plant', 'oneToOne', 'admin::user'> & Attribute.Private
    updatedBy: Attribute.Relation<'api::plant.plant', 'oneToOne', 'admin::user'> & Attribute.Private
  }
}

export interface ApiPushSubscriptionPushSubscription extends Schema.CollectionType {
  ...
  attributes: {
    user: Attribute.Relation<'api::push-subscription.push-subscription', 'manyToOne', 'plugin::users-permissions.user'>
    subscription: Attribute.JSON & Attribute.Required
    createdAt: Attribute.DateTime
    updatedAt: Attribute.DateTime
    createdBy: Attribute.Relation<'api::push-subscription.push-subscription', 'oneToOne', 'admin::user'> & Attribute.Private
    updatedBy: Attribute.Relation<'api::push-subscription.push-subscription', 'oneToOne', 'admin::user'> & Attribute.Private
  }
}
...
export interface ApiTagTag extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String & Attribute.Required
    user: Attribute.Relation<'api::tag.tag', 'oneToOne', 'plugin::users-permissions.user'>
    createdAt: Attribute.DateTime
    updatedAt: Attribute.DateTime
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::history-element.history-element': ApiHistoryElementHistoryElement
